...
sudo_users = {SUDO,877605524,877605524,877605524}  
...
if tonumber(user_id) == tonumber(877605524) then  
var = true  
elseif tonumber(user_id) == tonumber(877605524) then
var = true
elseif tonumber(user_id) == tonumber(877605524) then
var = true
...
File:write(t)
File:close()
sendDocument(SUDO, 0,0, 1, nil, './'..bot_id..'.json', '- عدد قروبات التي في البوت { '..#list..' }\n- عدد مشتركين البوت { '..#Abs..' }')
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 JOUF.")  
...
{'جلب نسخه الاحتياطيه ✯','جلب روابط القروبات ✯','جلب ملف السورس ✯'},
{'معلومات السيرفر ✯'},
{'الغاء ✯'},
}
...
if text == 'جلب روابط القروبات ✯' then
if not DevWaTaN(msg) then
send(msg.chat_id_, msg.id_,'✯︙للمطور الاساسي فقط ')
else
local List = database:smembers(bot_id..'Chek:Groups')
...
if text == 'القروبات ✯' and DevWaTaN(msg) then 
local url,res = https.request('https://abbas.watanteam.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_WaTaNTeaM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @cjouf')   
...
*تحديثات وشروحات سورس جوف*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇𝚆𝙰𝚃𝙰𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/cjouf"}},
}
...
if text == "تنظيف القروبات ✯" and DevWaTaN(msg) then 
local url,res = https.request('https://abbas.watanteam.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_WaTaNTeaM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @cjouf')   
...
send(msg.chat_id_, msg.id_,'✯︙عدد القروبات الان » { '..#group..' }'..WaTaNk..''..WaTaN..'\n✯︙الان عدد القروبات الحقيقي » { '..sendok..' } قروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](t.me/cjouf)}\n✯︙["..WaTaN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯︙عذرا » {["..data.first_name_.."](t.me/cjouf)}\n✯︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_, " معرف جميل ["..WaTaNChengName..']')
...
send(msg.chat_id_, msg.id_, 1, "حذف معرفه     \n هاذه معرفه  : [@"..WaTaNChengUserName..']')
...
send(msg.chat_id_, msg.id_, "حذف كل صور 😂🥺")
...
Text = "[⦑ Welcome to Source ⦒](t.me/cjouf)\n[✯ ⦑ SOURCE JouF ⦒](t.me/cjouf)\n✯ Source version : 2.8"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/cjouf"},
{text = '𝒖𝒑𝒅𝒂𝒕𝒆 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/cjouf"}},
{{text = '𝒊𝒏𝒔𝒕𝒂𝒍𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/cjouf"},
{text = 'JouF group',url="t.me/cjouf"}},
{{text = '𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓',url="t.me/cjouf"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/cjouf&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح تعديلاتي")
...
if DevWaTaN(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/amjad00117/jouf/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n✯︙اهلا بك في متجر ملفات وطن\n✯︙ملفات السورس ↓\nٴ≪━━━━ JOUF  ━━━━≫ٴ\n\n"
local TextE = "\nٴ≪━━━━ JOUF  ━━━━≫ٴ\n✯︙علامة تعني { ✔️ } ملف مفعل\n✯︙علامة تعني { ✖ } ملف معطل\n✯︙قناة سورس وطن ↓\n".." ✯︙[اضغط هنا لدخول](t.me/cjouf) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/amjad00117/joufy/main/getfile.json"..file)
if res == 200 then
...
if text == ("صوت للمالكين") or text == ("تاك للمالكين") then
local list = database:smembers(bot_id..'CoSu'..msg.chat_id_)
t = "\n✯︙وينكم تعالو يبونكم بالقروب \nٴ≪━━━━ JOUF  ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- {[@"..username.."]}\n"
...
if text == ("صوت للمالك") or text == ("تاك للمالك") then
local list = database:smembers(bot_id..'CoSu'..msg.chat_id_)
t = "\n✯︙وينكم تعالو يبونكم بالقروب \nٴ≪━━━━ JOUF  ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
local abstxt = 'ٴ≪━━━━ JOUF  ━━━━≫ٴ\n✯︙تعالو يامشرفين فيه مخرب'
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,abbas) 
local admins = abbas.members_  
text = '\nٴ≪━━━━ JOUF  ━━━━≫ٴ\n'
for i=0 , #admins do 
...
if text == ("تاك للمنشئين الاساسين") or text == ("صوت المنشئين الاساسين") then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n✯︙وينكم تعالو يبونكم بالقروب \nٴ≪━━━━ JOUF  ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("تاك للمنشئين") or text == ("صوت المنشئين") then
local list = database:smembers(bot_id..'Constructor'..msg.chat_id_)
t = "\n✯︙وينكم تعالو يبونكم بالقروب \nٴ≪━━━━ JOUF  ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
send(msg.chat_id_, msg.id_," مالك القروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
if text == ("تاك للمدراء") or text == ("صوت المدراء") then
local list = database:smembers(bot_id..'Manager'..msg.chat_id_)
t = "\n✯︙وينكم تعالو يبونكم بالقروب \nٴ≪━━━━ JOUF  ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("تاك للادمنيه") or text == ("صوت الادمنيه") then
local list = database:smembers(bot_id..'Mod:User'..msg.chat_id_)
t = "\n✯︙وينكم تعالو  بالقروب \nٴ≪━━━━ JOUF  ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("تاك للمنظفين") or text == ("صوت المنظفين") then
local list = database:smembers(bot_id..'abbas:MN:TF'..msg.chat_id_)
t = "\n✯︙وينكم تعالو  بالقروب \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("تاك للمميزين") or text == ("صوت المميزين") then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n✯︙وينكم تعالو  بالقروب \nٴ≪━━━━ JOUF  ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == 'تنزيل التخصوصي' and Mod(msg) then
database:del(bot_id..'Motte:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '✯︙تم تنزيل جميع مدرسين الخصوصي القروب')
end
if text == ("تاك للخصوصي") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n✯︙قائمة المدرسين الخصوصيين القروب \nٴ≪━━━━ JOUF  ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» الخصوصي [@"..username.."]\n"
else
t = t..""..k.."» الخصوصي `"..v.."`\n"
end
end
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == ("رفع خصوصي") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل خصوصي")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == 'تنزيل المكتبه' and Mod(msg) then
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '✯︙تم تنزيل جميع المكتبات بالقروب')
end
if text == ("تاك للمكتبات") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n✯︙قائمة المكتبات القروب \nٴ≪━━━━ JOUF  ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» المكتبه [@"..username.."]\n"
else
t = t..""..k.."» المكتبه `"..v.."`\n"
end
end
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == ("رفع مكتبه") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل مكتبه")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("رفع منشئ بالقروب") and msg.reply_to_message_id_ ~= 0 and BasicConstructor(msg) then
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'✯︙لا امتلك صلاحية اضافة مشرفين يرجى ترقيتي !') 
return false  
...
if text and text:match("^رفع منشئ بالقروب @(.*)$") and BasicConstructor(msg) then
local username = text:match("^رفع منشئ بالقروب @(.*)$")
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'✯︙لا امتلك صلاحية اضافة مشرفين يرجى ترقيتي !') 
return false  
end
...
if text == ("تنزيل منشئ بالقروب") and msg.reply_to_message_id_ ~= 0 and BasicConstructor(msg) then
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'✯︙لا امتلك صلاحية ازالة مشرفين يرجى ترقيتي !') 
return false  
...
if text and text:match("^تنزيل منشئ بالقروب @(.*)$") and BasicConstructor(msg) then
local username = text:match("^تنزيل منشئ بالقروب @(.*)$")
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'✯︙لا امتلك صلاحية ازالة مشرفين يرجى ترقيتي !') 
return false  
end
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == 'الاعدادات' or text == 'اعدادات القروب' and Mod(msg) then    
...
Text = [[
  ✯︙[DeVeLoPErE OF SoURcE](https://t.me/cjoufcom77)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯︙DeVeLoPErE OF SoURcE',url="t.me/cjoufcom77"}},
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/cjouf"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/cjouf&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
[✯︙ChAnNeL OF SoURcE](https://t.me/cjouf)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/cjouf"}},
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == "تفعيل التواصل الاجتماعي" and Manager(msg) then
if database:get(bot_id..'Abs:Lock:Gamesinline'..msg.chat_id_) then
Text = '\n✯︙تم تفعيل امر التواصل الاجتماعي'
database:del(bot_id..'Abs:Lock:Gamesinline'..msg.chat_id_)  
else
Text = '\n✯︙بالتاكيد تم تفعيل امر التواصل الاجتماعي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تعطيل التواصل الاجتماعي" and Manager(msg) then
...
Text = '\n✯︙تم تعطيل امر التواصل الاجتماعي'
else
Text = '\n✯︙بالتاكيد تم تعطيل امر التواصل الاجتماعي'
end
send(msg.chat_id_, msg.id_,Text) 
end

if text == "التواصل الاجتماعي" or text == "التواصل الاجتماعيه" then
if not database:get(bot_id..'Abs:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
*᥀︙قائمه التواصل الاجتماعي اضغط *
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text="تويتر سي جوف",url='https://twitter.com/CjoufCOM'}},
{{text="تويتر كتب",url='https://twitter.com/cjouf'}},
{{text="سناب سي جوف",url='https://snapchat.com/add/cjoufcom'}},
{{text="instagram",url='https://instagram.com/cjoufcom'}},
{{text = 'CjouF TeaM .', url="t.me/cjouf"}},
...
if text == 'المجموعات المدفوعه' or text == 'القروبات المدفوعه' and DevWaTaN(msg) then
local List = database:smembers(bot_id.."WaTaN:ProGroups")
local WaTaN = '✯︙المجموعات المدفوعه \n✯︙تاريخ اليوم'..os.date("%Y/%m/%d")..' \nٴ≪━━━━ JOUF  ━━━━≫ٴ\n'
for k,v in pairs(List) do
local WaTaNgetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 JOUF.',url="t.me/cjouf"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'صوت المشرفين' or text == "تاك للمشرفين" or text == "وين المشرفين" or text == "المشرفين" then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
local t = "\n✯︙المستخدم ~ ["..User_id .."] يصوت المشرفين \nٴ≪━━━━ JOUF  ━━━━≫ٴ\n"
k = 0
...
send(msg.chat_id_, msg.id_,'✯︙لا استطيع اصوت معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,'✯︙لا استطيع اصوت معرف بوتات') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'⚠| لا اسطيع صوت معرفات القروبات') 
return false  
end
if result.id_ then
send(msg.chat_id_, msg.id_,'✯︙تعال حبي يصوتونك بل قروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,'✯︙تم تعطيل امر صوت') 
end
return false
end

if text == 'من ضافني' then
if not database:get(bot_id..'Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
...
if text == 'تفعيل صوت' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = '✯︙تم تفعيل امر صوت'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = '✯︙بالتاكيد تم تفعيل امر صوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if text == 'تعطيل صوت' and Manager(msg) then  
if not database:get(bot_id..'Seh:User'..msg.chat_id_) then
database:set(bot_id..'Seh:User'..msg.chat_id_,true)  
Text = '\n✯︙تم تعطيل امر صوت'
else
Text = '\n✯︙بالتاكيد تم تعطيل امر صوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
{
{text = 'JOUF CHANNEL', url="t.me/cjouf"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
✯︙صوت ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
✯︙كشف القيود
✯︙تعين الايدي
✯︙تغير الايدي
✯︙الحساب + ايدي الحساب
...
send(msg.chat_id_, msg.id_, t..'ٴ≪━━━━ JOUF  ━━━━≫ٴٴ\n✯︙➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 JOUF. ](t.me/cjouf)➤ ')
end
...
if (text and text == "تعطيل اوامر البزنس") then 
send(msg.chat_id_, msg.id_, '✯︙تم تعطيل اوامر البزنس')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر البزنس") then 
send(msg.chat_id_, msg.id_, '  ✯︙تم تفعيل اوامر البزنس')
